...
export const wasmplan_anneal_chunk_from_json: (a: number, b: number, c: number, d: number) => [number, number, number];
export const wasmplan_anneal_from_json: (a: number, b: number, c: number) => [number, number];
export const wasmplan_anneal_tune_temp_from_json: (a: number, b: number, c: number) => [number, number, number];
...
export const wasmplan_equalize_exact: (a: number, b: number, c: number) => [number, number, number];
export const wasmplan_equalize_exact_debug: (a: number, b: number, c: number) => [number, number, number, number];
...
export const wasmplan_randomize_minimize_county_splits: (a: number, b: number, c: number) => [number, number];
